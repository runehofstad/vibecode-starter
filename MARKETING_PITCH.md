# 🚀 Vibecode Starter: Fra Idé til Ferdig App på Timer - Ikke Dager
...
### De 29 Sub-Agents inkluderer:
- **Kjernutvikling:** Frontend, Backend (Supabase/Firebase/AWS), Mobile (React Native/iOS/Flutter)
- **Kvalitet & Testing:** Testing, Security, Accessibility, Performance
- **Infrastruktur:** DevOps, Docker, Monitoring, Database Migration
- **Integrasjon:** API/GraphQL, Payment, WebSocket, Email/SMS
- **Spesialisert:** AI/ML, Localization, PWA, SEO, Documentation

### Teknologi-stack:
- **Frontend:** React 18, TypeScript, Vite, Tailwind CSS
- **Backend:** Valg mellom Supabase, Firebase eller AWS
...
- Lokaliserte dato- og valutaformater
- Norsk BankID-integrasjon tilgjengelig
